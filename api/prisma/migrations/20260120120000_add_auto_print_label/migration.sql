...
INSERT INTO "new_Product" ("createdAt", "freezerLifespanDays", "id", "isLeftover", "leftoverRecipeId", "openedLifespanDays", "refrigeratorLifespanDays", "title", "trackCountBy", "updatedAt") SELECT "createdAt", "freezerLifespanDays", "id", "isLeftover", "leftoverRecipeId", "openedLifespanDays", "refrigeratorLifespanDays", "title", "trackCountBy", "updatedAt" FROM "Product";
DROP TABLE "Product";
