...
CREATE TABLE "new_ShoppingListItem" (
    ...
    CONSTRAINT "ShoppingListItem_shoppingTripId_fkey" FOREIGN KEY ("shoppingTripId") REFERENCES "ShoppingTrip" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_ShoppingListItem" ("checked", "createdAt", "fromLogistics", "id", "name", "productId", "quantity", "shoppingListId", "unit", "updatedAt") SELECT "checked", "createdAt", "fromLogistics", "id", "name", "productId", "quantity", "shoppingListId", "unit", "updatedAt" FROM "ShoppingListItem";
