...
INSERT INTO "new_MealPlan" ("createdAt", "date", "id", "productId", "quantity", "recipeId", "unit", "updatedAt") SELECT "createdAt", "date", "id", "productId", "quantity", "recipeId", "unit", "updatedAt" FROM "MealPlan";
DROP TABLE "MealPlan";
